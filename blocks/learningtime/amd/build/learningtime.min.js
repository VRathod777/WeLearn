...
define([
    ...
    return {
        ...
        init: function() {
            ...
            userId = $('.block-learningtime').data('userid');
        ...
        setupEventListeners: function() {
            ...
            function handleTimeRangeClick(e) {
                ...
                if (!range) {
                    console.error('No range value found on button:', this);
                    return;
                }
                ...
                // Call loadData on the main object
                self.loadData(range);
            }
            
            // Attach event listener
            $(document).on('click', '.block_learningtime .time-range-btn', handleTimeRangeClick);
        },
                ...
                chart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            data: minutesData,
                            backgroundColor: 'rgba(154, 140, 235, 1)',
                            borderColor: 'rgba(154, 140, 235, 1)',
                            borderWidth: 1,
                            tension: 0.4,
                            pointBackgroundColor: 'rgba(154, 140, 235, 1)',
                            pointRadius: 3,
                            pointHoverRadius: 5
                        }]
                    },
