...
$PAGE->set_url('/local/mb2builder/ajax/save-part.php');
...
// Set record data.
$data = Mb2builderPartsApi::set_record_data(['itemid' => $itemid, 'name' => '', 'partid' => $partid,
'democontent' => $democontent]);

// Update database demo content field.
Mb2builderPartsApi::update_record_data($data);
